...
# Examples:
#
# pow(2, 0) # => 1 >> 2 * 0 = 1   *base1 PASSING
# pow(2, 1) # => 2 >> 2 *  = 2  *base2 PASSING
# pow(2, 5) # => 32 >> 2 * 2 * 2 * 2 * 2 = 32  ==> base * pow(base, exponent-1) PASSING
# pow(3, 4) # => 81 ISSUE
# pow(4, 3) # => 64

# 3^4 = 81                      pow(3, 4)
# 3 * (3^3) = 81                3 * pow(3, 3)
# 3 * 3 * (3^2) = 81            3 * 3 * pow(3, 2)
# 3 * 3 * 3 * (3^1) = 81        3 * 3 * 3 * pow(3, 1)
# 3 * 3 * 3 * 3 = 81
...
# arr = [2, 1]
# return arr[0] if n == 0
# return arr.last if n == 1

# lucas_number(i-1) + lucas_number(i-2) = current num
#
# Examples:
#
# lucas_number(0)   # =>    2   **BASE
# lucas_number(1)   # =>    1   **BASE
# lucas_number(2)   # =>    3
# lucas_number(3)   # =>    4
# lucas_number(5)   # =>    11
# lucas_number(9)   # =>    76
...
# Y: shovel 
# N: shovel into empty arr
# return the arr

# Might not need the condi
